...
feature -- System calls and crashs:
   ...
   frozen trace_switch(flag: BOOLEAN) is
         -- May be used in combination with option "-trace" of command
   ...
   frozen sedb_breakpoint is
         -- May be used in combination with option "-trace" of command
         -- `compile_to_c' to set a breakpoint for sedb, the SmallEiffel debugger.
      external "SmallEiffel"
      end;
   ...
   not_yet_implemented is
	 ...
	 sedb_breakpoint;
         std_error.put_string("[
            ...
            SmallEiffel library, you may consider to post your
            implementation on the SmallEiffel mailing list.
                                                e-mail: SmallEiffel@loria.fr
