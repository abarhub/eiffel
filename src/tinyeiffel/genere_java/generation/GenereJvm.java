...
public interface GenereJvm {
	...
	public static final int IADD=1,FADD=2,DADD=3,ISUB=4,FSUB=5,DSUB=6,IMUL=7,FMUL=8,DMUL=9,
		...
		F2D=31,D2F=32,I2C=33,IFEQ=34,IF_ACMPNE=35,IFNE=36,DUP=37,RETURN=38,ARETURN=39,
		PUSHTHIS=40,ACONSTNULL=41,NOP=42,GOTO=43;
	...
	public abstract boolean verification(String rep);
